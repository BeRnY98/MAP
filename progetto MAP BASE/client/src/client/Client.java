...
public class Client {
	...
	*@throws IOException Se si verificano problemi di I/O nella creazione del socket.
	*@throws ClassNotFoundException Se non viene trovata una classe durante la deserializzazione.
	*/
	...
	/**
	*Metodo che gestisce la comunicazione tra il client e il server
	*@throws IOException se si verificano errori di input/output durante la comunicazione con il server.
	*@throws ClassNotFoundException se non viene trovata una classe durante la deserializzazione degli oggetti ricevuti dal server.
	* */
	private void talking() throws IOException, ClassNotFoundException {
		...
		do {
			...
			do {
				...
				if(risposta.contains("@ERROR") || risposta.isEmpty()){//****************************
	...
	/**
	 * Main della classe client.
	 * @param args argomenti passati per avviare il main.
	 */
	public static void main(String[] args){

		String addressSupp = "localhost";
		String portSupp = "2050";
