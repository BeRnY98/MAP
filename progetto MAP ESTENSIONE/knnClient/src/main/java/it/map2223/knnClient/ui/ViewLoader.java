package it.map2223.knnClient.ui;
...
public class ViewLoader {
	...
	/**
	 * Costruttore della classe ViewLoader. Inizializza il campo dati stage e imposta l'EventHandler per la chiusura della finestra.
	...
	private EventHandler<WindowEvent> confirmCloseEH = event -> {
	        ...
	        closeConfirmation.setHeaderText("Conferma");
    ...
    public void loadWelcome() {
		...
		try {
			loader = new FXMLLoader(Main.class.getResource("/it/map2223/knnClient/view/Welcome.fxml"));
    ...
    public void loadHome(boolean newWindow) {
		...
		try {
		    FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/it/map2223/knnClient/view/Home.fxml"));
		            Parent root = (Parent) fxmlLoader.load();
		            if(newWindow) {
		            	Stage newStage = new Stage();
			            newStage.setTitle("Knn Learner");
	...
	public void loadPredView() {
		...
		try {
		    FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/it/map2223/knnClient/view/PredPhase.fxml"));
		            Parent root = (Parent) fxmlLoader.load();
		    		stage.setScene(new Scene(root));
	...
	public void loadPreferences() {
		try {
		    FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/it/map2223/knnClient/view/Preferences.fxml"));
		            Parent root = (Parent) fxmlLoader.load();
		            Stage newStage = new Stage();
	...
	public void loadUserGuide() {
        ...
        webEngine.load( getClass().getResource("/it/map2223/knnClient/usermanual.html").toString() );
